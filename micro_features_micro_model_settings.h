...
constexpr int kCategoryCount = 5; // questa costante indica il numero di parole riconoscibili dal modello, in questo esempio 5: "si","no","daniele","unknow" e "silence"
